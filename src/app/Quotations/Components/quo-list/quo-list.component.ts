...
@Component({
  ...
  styleUrls: ['./quo-list.component.css']
})
export class QuoListComponent implements OnInit {
  ...
  getQuoHdrList(){
    ...
    this.vquolist=[];
    this.vct=0;
    //this._vquoserv.QuoManualListByUser('00012WB202503', this.vtkn).subscribe((res:VQuoHdrList[])=>{
    this._vquoserv.QuoManualListBySts('M', this.vtkn).subscribe((res:VQuoHdrList[])=>{
      this.vquolist=res;
  ...
  updateQuo(tipe:string, reqno:string,p_user:string){       
